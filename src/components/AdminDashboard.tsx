    ...
    >
      ...
      {tooltip && (
        ...
        >
          ...
          <div style={{ color: "#222", fontSize: fontSize + 2 }}>
            Value: {tooltip.value}
          </div>
        </div>
      )}
...
const AdminDashboard: React.FC = () => {
  ...
  const [selectedDataSet, setSelectedDataSet] =
    useState<keyof typeof sampleDataSets>("monthly");
    ...
    <div className="admin-dashboard">
      ...
      >
        <select
          ...
          className="data-selector text-black"
          style={{
            fontSize: 20,
            padding: "10px 24px",
            borderRadius: 8,
      ...
      >
        ...
        {tooltip && (
          ...
          >
            <div style={{ color: "#1976d2", fontWeight: 900, fontSize: 24 }}>
              {tooltip.label}
            </div>
            <div style={{ color: "#388e3c", fontSize: 22 }}>
              ${tooltip.value}
            </div>
          </div>
        )}
